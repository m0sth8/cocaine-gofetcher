...
func (gofetcher *Gofetcher) ExecuteRequest(req *http.Request, client *http.Client, attempt int) (*http.Response, error) {
	...
	gofetcher.Logger.Infof("Response code: %d, url: %s, runtime: %v",
...
func (gofetcher *Gofetcher) handler(method string, request cocaine.Request, response cocaine.Response) {
	...
	if err != nil {
		gofetcher.WriteError(response, &Request{URL: ""}, err)
		return
	}
...
func (gofetcher *Gofetcher) GetHandler(method string) func(ctx context.Context, request cocaine.Request, response cocaine.Response) {
	return func(ctx context.Context, request cocaine.Request, response cocaine.Response) {
